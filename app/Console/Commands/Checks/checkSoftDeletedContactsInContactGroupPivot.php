...
class CheckSoftDeletedContactsInContactGroupPivot extends AbstractSystemCheckCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'contact:checkSoftDeletedContactsInContactGroupPivot
                        {--recover=false}
                        {--batch-key=}
                        {--send-mail=true}';

    protected string $commandRef = 'contact:checkSoftDeletedContactsInContactGroupPivot';
    protected string $checkCode = 'soft_deleted_contacts_in_contact_group_pivot';
    protected string $checkName = 'Soft deleted contacten in contact groepen';
    ...
    {
        return 'Contactgroep-koppeling heeft soft deleted contact.';
    }
    ...
    {
        $summary = $issuesFound . ' contactgroep-koppelingen gekoppeld aan soft deleted contacten.';
