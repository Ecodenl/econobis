...
class checkWrongProjectPCRSettings extends Command
{
    ...
    protected $mailTo = 'patrick@xaris.nl';
    ...
    public function handle()
    {
        ...
        foreach($projects as $project) {
            if ($project->project_type_id === 8 && ($project->postalcode_link == "" || !preg_match($patternPostalcodes, $project->postalcode_link))) {
                ...
                //Dit is een SCE project
                if($project->postalcode_link == "" || !preg_match('/^[1-9a-zA-Z,]*$/', $project->postalcode_link)) {
                ...
                } else if ($project->postcode_link == "" && $project->address_number_series == "") {
                    $projectsWithWrongPCRSettings[$counter]['id'] = $project->id;
                    $projectsWithWrongPCRSettings[$counter]['reason'] = 'Dit is een SCE project en de postalcode_link en address_number_series zijn leeg';
                }
            }
            $counter++;
        }
