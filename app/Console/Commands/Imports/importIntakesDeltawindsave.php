...
class importIntakesDeltawindsave extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:importIntakesDeltawindsave';
...
//                Log::info('Count : ' . count($contact_email));
//                Log::info('Contact : ' . $contact_id);
