...
class checkJobsLogForRecovery extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'jobsLog:checkJobsLogForRecovery';
     ...
     * @var string
     */
    protected $description = 'Controle voor herstel foute JobsLog records';
    ...
    public function handle()
    {
        ...
        dd('Einde Controle voor herstel foute JobsLog records.');
    }
    ...
    {
        print_r("Start Controle voor herstel foute JobsLog records op: '" . $searchField1 . "' en '" . $searchField2 . "'.\n");
        foreach (
