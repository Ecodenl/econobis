...
//    }
    ...
    public function sharedPostalcodehousenumber(){
        return SharedPostalcodehousenumber::where('postal_code', str_replace(' ', '', $this->postal_code))->where('house_number', $this->number)->first();
    }
}
