    ...
    public function downloadCSV()
    {
        ...
        foreach ($this->contacts->chunk(500) as $chunk) {
            ...
            $mapping = [
                ...
                'occupationTitle.name' => 'Aanspreektitel vertegenwoordiger',
                'occupationFullName' => 'Volledige naam vertegenwoordiger',
                'occupationInitial' => 'Initialen vertegenwoordiger',
                'occupationFirstName' => 'Voornaam vertegenwoordiger',
                'occupationLastNamePrefix' => 'Tussenvoegsel vertegenwoordiger',
                'occupationLastName' => 'Achternaam vertegenwoordiger',
                'occupationDateOfBirth' => 'Geboortedatum vertegenwoordiger',
                'occupationPrimaryEmailAddress.email' => 'Primair e-mailadres vertegenwoordiger',
                'occupationPrimaryTelephoneNumber.number' => 'Primair telefoonnummer vertegenwoordiger',
