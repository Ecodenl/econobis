    ...
    public function downloadExcel()
    {
        ...
        foreach ($this->housingFileSpecifications->chunk(300) as $chunk) {
            foreach ($chunk as $housingFileSpecification) {
                ...
                $rowData[3] = ($housingFileSpecification->measure && $housingFileSpecification->measure->measureCategory) ? $housingFileSpecification->measure->measureCategory->name : ''; //'Maatregel'
                $rowData[4] = $housingFileSpecification->measure ? $housingFileSpecification->measure->name : ''; //'Maatregel categorie'
