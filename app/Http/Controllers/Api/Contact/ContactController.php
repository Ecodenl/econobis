...
//        }
        ...
        try{
            ...
            if (!$toContactHoomAccountId && $fromContactHoomAccountId) {
                ...
                return response()->json(['message' => 'Het Hoom account id van het oude contact is overgenomen naar het nieuwe contact, u moet het contact_id ook in het Hoomdossier aanpassen'], 200);
            } else {
