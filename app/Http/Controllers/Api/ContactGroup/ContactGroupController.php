...
class ContactGroupController extends Controller
{
    ...
    public function gridContacts(ContactGroup $contactGroup, Request $request)
    {
        ...
        return response()->json(['gridContactGroupContacts' => $gridContactGroupContacts, 'total' => $total]);
    }
