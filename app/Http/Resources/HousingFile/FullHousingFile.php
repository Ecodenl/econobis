    ...
    public function toArray($request)
    {
        return
            [
                ...
                'cookRype' => $this->cook_type,
                'heatSource' => $this->heat_source,
                'waterComfort' => $this->water_comfort,
                'pitchedRoofHeating' => $this->pitched_roof_heating,
                'flatRoofHeating' => $this->flat_roof_heating,
                'hr3pGlassFrameCurrentGlass' => $this->hr3p_glass_frame_current_glass,
                'glassInLeadReplaceRoomsHeated' => $this->glass_in_lead_replace_rooms_heated,
                'numberOfResidents' => $this->number_of_residents,
                'boilerSettingComfortHeat' => $this->boiler_setting_comfort_heat,
