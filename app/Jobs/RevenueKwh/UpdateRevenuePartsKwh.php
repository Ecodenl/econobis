...
class UpdateRevenuePartsKwh implements ShouldQueue
{
    ...
    public function __construct(RevenuePartsKwh $revenuePartsKwh, $valuesKwhData, $oldDateEnd, $userId, $alwaysRecalculate)
    {
    ...
    public function handle()
    {
        ...
        $this->revenuePartsKwh->calculator()->runRevenuePartsKwh($this->valuesKwhData, $this->oldDateEnd, $this->alwaysRecalculate);
