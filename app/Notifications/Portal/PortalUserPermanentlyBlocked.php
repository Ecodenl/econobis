...
//' . PortalSettings::get("portalName")  . '</a></p>')
            ->line('Jouw account is permanent geblokkeerd voor <a href="' . (PortalSettings::first()?->portal_url) . '" style="text-decoration: none;" target="_blank">**' . (PortalSettings::first()?->portal_name) . '**</a> wegens herhaaldelijk mislukte inlogpogingen.')
