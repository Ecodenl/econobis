    ...
    return (
        ...
        <div>
            ...
            <div className="col-sm-1">
                {(props.showActionButtons && props.permissions.manageFinancial ? <a role="button" onClick={() => props.downloadSepa(id)}><span className="glyphicon glyphicon-open-file mybtn-success"  /> </a> : '')}
