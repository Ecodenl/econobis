        ...
        return (
            ...
            >
                <div className="upload-file-content">
                    <Dropzone accept="image/jpeg, image/png, image/jpg" multiple={false} className="dropzone" onDropAccepted={this.onDropAccepted.bind(this)} onDropRejected={this.onDropRejected.bind(this)} maxSize={6000000}>
