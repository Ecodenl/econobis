...
class Reset extends Component{
	...
	render(){	
        ...
        let passwordMsg = (passwordError) ? 'Het wachtwoord moet minmaal 8 karakters lang zijn en moet minimaal 1 cijfer en 1 hoofdletter bevatten.' : null;
        let msg = (!error) ? 'Wachtwoord successvol gewijzigd' : 'Oeps! , er is iets fout gegaan' ;
			                ...
			                <div className="panel panel-default">
			                    ...
			                    <div className="panel-body">
			                    	<div className="col-md-offset-2 col-md-8 col-md-offset-2">
										...
										{passwordMsg != null && <div className='alert alert-danger' role="alert">{passwordMsg}</div>}
                                    </div>  
			                        <form className="form-horizontal" role="form"  onSubmit= {this.onSubmit.bind(this)}>
			                            ...
			                            <div className="form-group">
			                                <label htmlFor="password" className="col-md-4 control-label">Wachtwoord</label>
			                            ...
			                            <div className="form-group">
			                                <label htmlFor="password-confirm" className="col-md-4 control-label">Herhaal wachtwoord</label>
			                                <div className="col-md-6">
