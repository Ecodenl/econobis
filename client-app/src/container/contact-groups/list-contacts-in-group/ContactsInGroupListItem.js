        ...
        return (
            <tr className={this.state.highlightRow} onDoubleClick={() => this.openItem(id)} onMouseEnter={() => this.onRowEnter()} onMouseLeave={() => this.onRowLeave()}>
                ...
                <td>
                    ...
                    {(this.state.showActionButtons && permissions.updatePerson && permissions.updateOrganisation && this.props.contactGroupType && this.props.contactGroupType.id === 'static' ? <a role="button" onClick={this.props.showDeleteItemModal.bind(this, id, fullName)}><span className="glyphicon glyphicon-trash mybtn-danger"  /> </a> : '')}
                </td>
            </tr>
        );
    }
