...
const ContactDetailsFormPersonalView = props => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <ViewText label="Status" value={status && status.name} className={'col-xs-12 field-to-be-removed'} />
            </div>
            ...
            <div className="row">
                <ViewText label="Akkoord privacybeleid" value={didAgreeAvg ? 'Ja' : 'Nee'} className={'col-xs-12'} />
            </div>
        </div>
    );
};
