...
class DashboardChartContacts extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ContactsAPI.getChartData().then(payload => {
            ...
            <div>
                ...
                <div>
                    {amountOfDataPoints === 0 ? (
                        <span>Er zijn nog geen contacten.</span>
                    ) : (
...
export default DashboardChartContacts;
