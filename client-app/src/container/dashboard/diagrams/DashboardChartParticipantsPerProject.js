...
class DashboardChartParticipantsPerProject extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ProductionProjectsAPI.getChartData(this.props.id).then(payload => {
...
export default DashboardChartParticipantsPerProject;