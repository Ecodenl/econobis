    ...
    fetchCleanupData = () => {
        ...
        DataCleanupAPI.getCleanupItems().then(payload => {
            this.setState({
                ...
                financialOverviews: payload['financialOverviews'],
                tasks: payload['tasks'],
                opportunities: payload['opportunities'],
                intakes: payload['intakes'],
                housingFiles: payload['housingFiles'],
                paymentInvoices: payload['paymentInvoices'],
                revenues: payload['revenues'],
                revenuesKwh: payload['revenuesKwh'],
                    ...
                    return (
                        <DataCleanupListItems
                            data={{
                                ...
                                paymentInvoices: this.state.paymentInvoices,
