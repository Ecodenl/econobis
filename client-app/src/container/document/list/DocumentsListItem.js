        ...
        return (
          <tr className={this.state.highlightRow} onDoubleClick={() => this.openItem(id)} onMouseEnter={() => this.onRowEnter()} onMouseLeave={() => this.onRowLeave()}>
              ...
              <td>
                  ...
                  {(this.state.showActionButtons && filename.toLowerCase().endsWith('.pdf') ? <a role="button" onClick={() => hashHistory.push(`/document/inzien/${id}`)}><span className="glyphicon glyphicon-eye-open mybtn-success" /> </a> : '')}
