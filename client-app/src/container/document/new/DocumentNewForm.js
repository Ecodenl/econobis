...
const DocumentNewForm = ({document, contacts, contactGroups, templates, intakes, opportunities, errors, handleSubmit, handleInputChange, handleDocumentGroupChange, onDropAccepted, onDropRejected}) => {
