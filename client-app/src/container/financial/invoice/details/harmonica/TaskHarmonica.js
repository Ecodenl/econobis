        ...
        <Panel className={"harmonica-button"}>
            <PanelBody>
                <div className="col-sm-10" onClick={toggleShowList} role="button">
                    <span>TAKEN/NOTITIES <span className="badge">{ taskCount }</span></span>
                </div>
                <div className={"col-sm-2"}>
                    ...
                    <div  className="pull-right">
                        ...
                        <ul className="dropdown-menu">
                            <li><a className="btn" onClick={() => newTask('open')}>Maak taak</a></li>
                            <li><a className="btn" onClick={() => newTask('afgehandeld')}>Maak notitie</a></li>
                        </ul>
                    </div>
                    }
                </div>
