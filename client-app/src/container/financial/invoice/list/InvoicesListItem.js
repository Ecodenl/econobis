...
class InvoicesListItem extends Component {
    ...
    render() {
        ...
        const { id, number, date, subject, orderContactFullName, paymentType, status, daysToExpire, daysLastReminder, totalPriceInclVatAndReduction, amountOpen, emailToAddress, checked, iban, subStatus, usesTwinfield } = this.props;
        return (
