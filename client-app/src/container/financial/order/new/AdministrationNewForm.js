...
import OrderLogoNew from "./OrderLogoNew";
...
class OrderNewForm extends Component {
    ...
    handleSubmit = event => {
        ...
        OrderDetailsAPI.newOrder(data).then((payload) => {
    ...
    render() {
        const { name, orderNumber, address, postalCode, city, countryId, kvkNumber, btwNumber, IBAN, email, website, bic, sepaContractName, sepaCreditorId, rsinNumber, defaultPaymentTerm, attachment} = this.state.order;
