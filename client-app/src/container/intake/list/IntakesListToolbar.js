            ...
            <div className="row">
                <div className="col-md-4">
                    <div className="btn-group" role="group">
                        ...
                        <ButtonIcon iconName={'glyphicon-download-alt'} title="Download intakes" onClickAction={this.props.getExcel} />
                        <ButtonIcon iconName={'glyphicon-download-alt'} title="Download intakes met kansen" onClickAction={this.props.getExcelWithOpportunities} />
                    </div>
                </div>
                <div className="col-md-4">
