        ...
        return (
            <Panel>
                <PanelHeader>
                    ...
                    <span className="h5 text-bold">Welke e-mailadressen en of domeinnamen moeten niet gekoppeld worden aan contacten</span>
                ...
                <PanelBody>
                    ...
                    <div className="col-md-12 margin-10-top">
                        {this.state.showNew &&
                        <MailboxDetailsIgnoresNew toggleShowNew={this.toggleShowNew}/>}
                    </div>
                </PanelBody>
            </Panel>
        );
