...
export default function MailgunDomainDetailsComplaints({ mailgunDomainId }) {
    ...
    const fetch = () => {
        ...
        return getAxiosInstance()
            .get('/mailgun-domain/' + mailgunDomainId + '/complaint')
            .then(response => {
                setComplaints(
    ...
    const handleAddSubmit = e => {
        ...
        return getAxiosInstance()
            .post('/mailgun-domain/' + mailgunDomainId + '/complaint', {
    ...
    const handleDeleteSubmit = () => {
        return getAxiosInstance()
            .post('/mailgun-domain/' + mailgunDomainId + '/complaint/' + deletingComplaint.address + '/delete')
            .then(() => {
            ...
            <PanelHeader>
                <span className="h5 text-bold">
                    ...
                    <FaInfoCircle
                        ...
                        size={'15px'}
                        data-tip={
                            'Deze lijst toont e-mailadressen waarbij de ontvanger het ontvangen mailtje van jullie domein als spam heeft gemarkeerd.' +
