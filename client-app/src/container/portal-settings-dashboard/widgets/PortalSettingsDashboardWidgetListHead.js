...
const PortalSettingsDashboardWidgetListHead = props => {
    return (
        <tr className="thead-title">
            ...
            <DataTableHeadTitle title={'Titel'} width={props.edit ? '15%' : '20%'} />
            <DataTableHeadTitle title={'Tekst'} width={props.edit ? '25%' : '27.5%'} />
            <DataTableHeadTitle title={'Afbeelding'} width={'20'} />
            <DataTableHeadTitle title={'Knoptekst'} width={'10%'} />
            <DataTableHeadTitle title={'Knoplink'} width={'15%'} />
            <DataTableHeadTitle title={'Actief'} width={'7.5%'} />
