...
const PostalCodeLinkDeleteItem = (props) => {
    ...
    return (
        <Modal
            ...
            title="Verwijderen"
        >
            Verwijder postcode roos: <strong> { props.postalCodeMain } </strong>gelinkt met <strong>{ props.postalCodeLink }</strong>?
        </Modal>
    );
};
...
export default connect(null, mapDispatchToProps)(PostalCodeLinkDeleteItem);
