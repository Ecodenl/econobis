...
class PostalCodeLinkEditForm extends Component {
    constructor(props) {
        super(props);

        this.state = {
            postalCodeLink: {
                id: props.postalCodeLink.id,
                postalCodeMain: props.postalCodeLink.postalCodeMain,
                postalCodeLink: props.postalCodeLink.postalCodeLink,
    ...
    handleSubmit = event => {
        ...
        !hasErrors &&
        PostalCodeLinkAPI.updatePostalCodeLink(postalCodeLink).then((payload) => {
                ...
                <Panel>
                    ...
                    <PanelBody>
                        <div className="pull-right btn-group" role="group">
                            <ButtonText buttonClassName={"btn-default"} buttonText={"Sluiten"} onClickAction={this.props.toggleShowEdit}/>
...
export default PostalCodeLinkEditForm;
