    ...
    return (
        <div>
            ...
            <div className="row" onClick={props.switchToEdit}>
                ...
                <ViewText label={'Status'} value={productionProjectStatus ? productionProjectStatus.name : ''} />
            </div>
            ...
            <div className="row" onClick={props.switchToEdit}>
                <ViewText label={'Type'} value={productionProjectType ? productionProjectType.name : ''} />
