    ...
    return (
        <div>
            ...
            {props.productionProjectRevenue.confirmed ? (
                props.productionProjectRevenue.distribution &&
                props.productionProjectRevenue.distribution.data.length > 0 ? (
            ...
            <DataTablePagination
                ...
                totalRecords={
                    props.productionProjectRevenue.confirmed
                        ? props.productionProjectRevenue.distribution &&
                          props.productionProjectRevenue.distribution.meta.total
                        : props.productionProjectRevenue.participants &&
                          props.productionProjectRevenue.participants.meta.total
                }
            />
        </div>
    );
