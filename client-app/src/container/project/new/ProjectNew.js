    ...
    return (
        <form className="form-horizontal col-md-12" onSubmit={props.handleSubmit}>
            ...
            <div className="row">
                ...
                />
                <InputText label={'Adres'} name={'address'} value={address} onChangeAction={props.handleInputChange} />
            </div>

            <div className="row">
                <InputText label={'Plaats'} name={'city'} value={city} onChangeAction={props.handleInputChange} />
            </div>
            ...
            {props.showPostalCodeLinkFields && (
                <div className="margin-20-bottom">
                    <div className="row">
                        <InputText label={'EAN'} name={'ean'} value={ean} onChangeAction={props.handleInputChange} />
                        <InputText
                            label={'EAN Netbeheer'}
                            name={'eanManager'}
                            value={eanManager}
