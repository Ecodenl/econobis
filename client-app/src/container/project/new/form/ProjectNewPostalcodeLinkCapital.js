...
const ProjectFormNewPostalcodeLinkCapital = ({
    postalcodeLink,
    taxReferral,
    eanManager,
    ean,
...
export default connect(mapStateToProps)(ProjectFormNewPostalcodeLinkCapital);
