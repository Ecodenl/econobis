...
import twinfieldLogMessageTypes from '../../../data/twinfieldLogMessageTypes';

function TwinfieldListFilter({ filter, handleChangeFilter }) {
    return (
        <tr className="thead-filter">
            ...
            <th>
                ...
                >
                    <option />
                    {twinfieldLogMessageTypes.map(option => {
                        return (
...
export default TwinfieldListFilter;
