...
export function* fetchParticipantsProductionProjectSaga({
    filters,
    extraFilters,
    sorts,
    pagination,
    ...
    try {
        ...
        const participantsProductionProject = yield call(
            ParticipantsProductionProjectAPI.fetchParticipantsProductionProject,
            { filters, extraFilters, sorts, pagination, filterType, fetchFromProductionProject }
        );
