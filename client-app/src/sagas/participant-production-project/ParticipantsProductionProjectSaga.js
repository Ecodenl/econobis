...
export function* fetchParticipantsProductionProjectSaga({filters, extraFilters,sorts, pagination, productionProjectId}) {
    try {
        ...
        const participantsProductionProject = yield call(ParticipantsProductionProjectAPI.fetchParticipantsProductionProject, {filters, extraFilters, sorts, pagination, productionProjectId});
