...
export function* fetchProductionProjectRevenueParticipantsSaga(data) {
    try {
        ...
        const productionProjectRevenueParticipants = yield call(
            ProductionProjectRevenueAPI.fetchProductionProjectRevenueParticipants,
            data.data.id,
            data.data.page
        );
        document.body.style.cursor = 'default';
        yield put({
            type: 'PRODUCTION_PROJECT_REVENUE_GET_PARTICIPANTS_SUCCESS',
            productionProjectRevenueParticipants,
        });
    } catch (error) {
        document.body.style.cursor = 'default';
...
export function* fetchProductionProjectRevenueDistributionSaga(data) {
    try {
        document.body.style.cursor = 'wait';
        const productionProjectRevenueDistribution = yield call(
            ProductionProjectRevenueAPI.fetchProductionProjectRevenueDistribution,
            data.data.id,
            data.data.page
        );
        document.body.style.cursor = 'default';
        yield put({
            type: 'PRODUCTION_PROJECT_REVENUE_GET_DISTRIBUTION_SUCCESS',
            productionProjectRevenueDistribution,
        });
    } catch (error) {
        document.body.style.cursor = 'default';
