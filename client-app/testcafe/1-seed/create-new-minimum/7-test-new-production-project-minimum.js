...
test('Fill out form new production project -> participant -> value course', async t => {
    ...
    await t
        ...
        .eql('Productieproject ' + vars.productionProjectName, 'Check element text', { timeout: 500 });

    await t
        .click(
            generalProductionProject.rapportageButton
                .prevSibling()
                .prevSibling()
                .nth(1)
        )
    ...
    await t.click(generalProductionProject.details).wait(constants.wait);

    await t.click(detailsProductionProject.newValueCourse).wait(constants.wait);
