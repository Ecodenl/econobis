...
test('Fill out form invoice minimum', async t => {
    ...
    await t.click(financial.allOrders).wait(constants.wait);
    ...
    await t.click(detailsOrder.newInvoice);

    await t.click(previewOrder.createInvoices).click(previewOrder.createInvoicesConfirm);
});
