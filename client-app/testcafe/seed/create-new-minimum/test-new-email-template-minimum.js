...
test('Fill out form email template minimum', async (t) => {
    ...
    await t.expect(Selector('h3').innerText).eql('Nieuwe e-mail template', 'Check element text', { timeout: 500 });
    ...
    await t.expect(Selector('h4').innerText).eql('E-mail template: ' + randomWord, 'Check element text', { timeout: 500 });
});