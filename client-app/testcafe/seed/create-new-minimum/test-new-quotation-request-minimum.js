...
test('Fill out form organisation->person->intake->opportunity->quotationRequest', async (t) => {
    ...
    await t
        .click(Selector('span').withExactText('Offerteverzoek').parent().child('a'))
        .click('select[name="organisationId"]')
        .click(Selector('option').withExactText(randomName))
        .click('select[name="statusId"]')
