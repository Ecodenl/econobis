...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Todo @@HIGH Externe afbeeldingen zijn nodig voor bestaande documenttemplates.
         *  Voorlopig zijn alle hosts toegestaan om bestaande functionaliteit
         *  uit Dompdf 2.x te behouden. Later onderzoeken of een veilige,
         *  dynamische hostbeperking mogelijk is.
         *
         * @var array|null
         */
