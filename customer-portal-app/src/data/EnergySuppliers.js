export default [
    ...
    { id: 54, name: 'Clean Energy (www.cleanenergy.nl)' },
    ...
    { id: 53, name: 'DVEP Energie (www.dvep.nl)' },
    { id: 3, name: 'E.on' },
    ...
    { id: 52, name: 'EnerZie (www.enerzie.eu)' },
    { id: 6, name: 'Engie' },
    { id: 7, name: 'Essent' },
    { id: 35, name: 'Fenor energie' },
    { id: 56, name: 'Gezinsenergie (Gezinsenergie.nl)' },
    ...
    { id: 16, name: 'Qurrent' },
    { id: 48, name: 'Qwint' },
    { id: 55, name: 'Samsam (wijsamsam.nl)' },
