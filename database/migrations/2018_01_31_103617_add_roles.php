...
class AddRoles extends Migration
{
    ...
    public function up()
    {
        ...
        $roles = ['Medewerker' => ['create_person', 'view_person', 'update_person', 'delete_person', 'create_organisation', 'view_organisation', 'update_organisation', 'manage_task', 'create_document', 'view_document', 'view_audit_trail', 'view_mailbox'],
            ...
            'Energie adviseur' => ['create_person', 'view_person', 'update_person', 'delete_person', 'create_organisation', 'view_organisation', 'update_organisation', 'manage_group', 'manage_opportunity', 'manage_task', 'manage_registration', 'manage_measure', 'create_document', 'view_document', 'view_audit_trail', 'create_mailbox'],
