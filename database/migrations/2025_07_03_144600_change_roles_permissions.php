...
class ChangeRolesPermissions extends Migration
{
    ...
    public function up()
    {
        ...
        // Verwijder van 'Medewerker': permission menu_projects, view_project, view_participation en menu_energy_saving + submenus
        ...
        // Verwijder van 'Medewerker 2': permission menu_projects, view_project, view_participation en menu_energy_saving + submenus
        ...
        // Voeg toe aan 'Projectmanager': permission manage_project
        ...
        // Verwijder van 'Financieel medewerker': permission menu_projects, view_project, manage_participation, view_participation en menu_energy_saving + submenus
        ...
        // Verwijder van 'Financieel controller': permission manage_project, menu_projects, view_project, manage_participation, view_participation en menu_energy_saving + submenus
        ...
        if ($participatieMedewerker) {
            $participatieMedewerker->givePermissionTo('menu_participation');
        ...
        // Verwijder van 'Energie adviseur': permission menu_projects, view_project en view_participation
        ...
        // Verwijder van 'Marketing medewerker': permission menu_projects, view_project en view_participation
    ...
    {
        // Voeg terug toe aan 'Medewerker': permission menu_projects, view_project, view_participation en menu_energy_saving + submenus
        $medewerker = Role::findByName('Medewerker');
        if ($medewerker) {
        ...
        // Voeg terug toe aan 'Medewerker 2': permission menu_projects, view_project, view_participation en menu_energy_saving + submenus
        $medewerker2 = Role::findByName('Medewerker 2');
        if ($medewerker2) {
        ...
        // Verwijder van 'Projectmanager': permission manage_project en menu_energy_saving + submenus
        ...
        // Voeg terug toe aan 'Financieel medewerker': permission menu_projects, view_project, manage_participation, view_participation en menu_energy_saving + submenus
        $financieelMedewerker = Role::findByName('Financieel medewerker');
        if ($financieelMedewerker) {
        ...
        // Voeg terug toe aan 'Financieel controller': permission manage_project, menu_projects, view_project, manage_participation, view_participation en menu_energy_saving + submenus
        $financieelController = Role::findByName('Financieel controller');
        if ($financieelController) {
        ...
        // Voeg terug toe aan 'Energie adviseur': permission menu_projects, view_project en view_participation
        $energieAdviseur = Role::findByName('Energie adviseur');
        if ($energieAdviseur) {
        ...
        // Voeg terug toe aan 'Marketing medewerker': permission menu_projects, view_project en view_participation
        $marketingMedewerker = Role::findByName('Marketing medewerker');
        if ($marketingMedewerker) {
