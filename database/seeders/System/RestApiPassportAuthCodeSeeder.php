...
class RestApiPassportAuthCodeSeeder extends Seeder
{
    public function run(): void
    {
        // Auth Code client (geen password / personal access)

        $appName = config('app.name');

        $clientName = "Econobis {$appName} Rest-API AuthCode Client";

        $redirect = config('rest-api-oauth.redirect_url');
