  ...
  [99],
  {
      ...
      t.exports = (function(t) {
        ...
        var s = o,
          ...
          u = {
            ...
            getAlpha: function(t) {
              var e = d(t);
              return e || (e = c(t)) || (e = h(t)) ? e[3] : void 0;
            },
                ...
                switch ((t.beginPath(), e)) {
                  ...
                  case "rectRounded":
                    (u = n - (d = 0.516 * n)),
                      (s = Math.cos(c + T) * u),
                      (l = Math.sin(c + T) * u),
                      t.arc(i - s, a - l, d, c - P, c - I),
                      t.arc(i + l, a - s, d, c - I, c),
                      t.arc(i + s, a + l, d, c, c + I),
                      t.arc(i - l, a + s, d, c + I, c + P),
                      t.closePath();
                    break;
                  case "rect":
                    if (!r) {
          ...
          _resolveDataElementOptions: function(t, e) {
            ...
            if (((i = i || {}), V.isArray(h)))
              for (o = 0, s = h.length; o < s; ++o)
                f[(l = h[o])] = J([i[l], d[l], c[l]], g, e, p);
            else
              for (o = 0, s = (r = Object.keys(h)).length; o < s; ++o)
                f[(l = r[o])] = J([i[l], d[h[l]], d[l], c[l]], g, e, p);
        ...
        var Dt = nt.extend({
            ...
            _updateElementGeometry: function(t, e, n, i) {
              ...
              (r.horizontal = l),
                (r.base = n ? s : d.base),
                (r.x = l ? (n ? s : d.head) : c.center),
                (r.y = l ? c.center : n ? s : d.head),
                (r.height = l ? c.size : void 0),
                (r.width = l ? void 0 : c.size);
            },
            ...
            calculateBarValuePixels: function(t, e, n) {
              ...
              if (v || (void 0 === v && void 0 !== b))
                for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
                  a.stack === b &&
                    ((r =
                      void 0 === (u = c._parseValue(f[a.index].data[e])).start
                        ? u.end
                        : u.min >= 0 && u.max >= 0
                        ? u.max
                        : u.min),
                    ((p.min < 0 && r < 0) || (p.max >= 0 && r > 0)) &&
                      (y += r));
              return (
                (o = c.getPixelForValue(y)),
                (l = (s = c.getPixelForValue(y + x)) - o),
                void 0 !== m &&
                  Math.abs(l) < m &&
                  ((l = m),
                  (s = (x >= 0 && !h) || (x < 0 && h) ? o - m : o + m)),
          ...
          update: function(t) {
            ...
            if (m < Rt) {
              var b = l.rotation % Rt,
                ...
                C = (b <= zt && y >= zt) || y >= Rt + zt,
                S = (b <= -zt && y >= -zt) || y >= Lt + zt,
                P = b === -Lt || y >= Lt ? -1 : Math.min(x, x * p, k, k * p),
          ...
          updateElement: function(t, e, n) {
            ...
            V.extend(t, {
              ...
              _model: {
                ...
                outerRadius: p,
                innerRadius: g,
                label: V.valueAtIndexOrDefault(h.label, e, a.data.labels[e])
              }
            });
            var v = t._model;
            (n && s.animateRotate) ||
        ...
        var Ut = nt.extend({
            ...
            _resolveDatasetElementOptions: function(t) {
              ...
              return (
                (o.spanGaps = Bt(n.spanGaps, a.spanGaps)),
                (o.tension = Bt(n.lineTension, r.tension)),
              ...
              if (c.options.stacked) {
                for (
                  ...
                  (a = d.data.datasets[r.index]),
                    "line" === r.type &&
                      r.yAxisID === c.id &&
                      ((o = +c.getRightValue(a.data[e])) < 0
                        ? (f += o || 0)
                        : (h += o || 0));
                return s < 0
                  ? c.getPixelForValue(f + s)
                  : c.getPixelForValue(h + s);
              }
        ...
        var Xt = nt.extend({
          ...
          updateElement: function(t, e, n) {
            ...
            (t._scale = o),
              ...
              (t._model = {
                ...
                borderColor: l.borderColor,
                borderWidth: l.borderWidth,
                tension: Gt(a.tension, u ? u.tension : 0),
                hitRadius: l.hitRadius
              });
          },
          _resolveDatasetElementOptions: function() {
            ...
            return (
              (i.spanGaps = Gt(e.spanGaps, n.spanGaps)),
              (i.tension = Gt(e.lineTension, n.elements.line.tension)),
              i
            );
          },
          updateBezierControlPoints: function() {
          ...
          setHoverStyle: function(t) {
            ...
            (t.$previousStyle = {
              ...
              (e.borderColor = Gt(n.hoverBorderColor, i(n.borderColor))),
              (e.borderWidth = Gt(n.hoverBorderWidth, n.borderWidth)),
              (e.radius = Gt(n.hoverRadius, n.radius));
          }
        });
        z._set("scatter", {
          hover: { mode: "single" },
              ...
              if (t) {
                ...
                !(function(t, e) {
                  ...
                  V.each(s.chartArea, function(e) {
                    var n = e.box;
                    re(n, t.chartArea), n.update(c.w, c.h);
                  });
              }
            }
          },
        ...
        function Me(t, e, n) {
          var i,
            ...
            l = (s.resizer = (function(t) {
              ...
              return (
                xe(n, "scroll", a.bind(n, "expand")),
                xe(i, "scroll", a.bind(i, "shrink")),
                e
              );
            })(
              ((i = function() {
        ...
        (V.addEvent = xe), (V.removeEvent = _e);
        var Pe = Se._enabled
            ? Se
            : {
        ...
        var Be = $.extend({
            ...
            update: function(t) {
              ...
              if (p.length) {
                ...
                var _ = [],
                  k = [];
                x = Fe[h.position].call(c, p, c._eventPosition);
                var w = [];
                ...
                h.filter &&
                  ...
                  V.each(w, function(t) {
                    _.push(h.callbacks.labelColor.call(c, t, c._chart)),
                      k.push(h.callbacks.labelTextColor.call(c, t, c._chart));
                  }),
                  (g.title = c.getTitle(w, m)),
                  (g.beforeBody = c.getBeforeBody(w, m)),
                  (g.body = c.getBody(w, m)),
                  (g.afterBody = c.getAfterBody(w, m)),
                  (g.footer = c.getFooter(w, m)),
                  (g.x = x.x),
                  (g.y = x.y),
            ...
            drawBody: function(t, e, n) {
              ...
              for (
                n.textAlign = f,
                  n.textBaseline = "middle",
                  n.font = V.fontString(c, e._bodyFontStyle, e._bodyFontFamily),
                  t.x = Ee(e, x),
              ...
              (m = 0), V.each(e.afterBody, y), (t.y -= h);
            },
                ...
                for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                  (o = n[t][a]),
                    ...
                    !e[t][a].type || (o.type && o.type !== e[t][a].type)
                      ? V.merge(e[t][a], [Ie.getScaleDefaults(r), o])
                      : V.merge(e[t][a], o);
          ...
          return V.merge({}, [].slice.call(arguments), {
            merger: function(t, e, n, i) {
              ...
              "scales" === t
                ? (e[t] = He(a, r))
                : "scale" === t
                ? (e[t] = V.merge(a, [Ie.getScaleDefaults(r.type), r]))
                : V._merger(t, e, n, i);
            }
          });
        }
        ...
        V.extend(Ge.prototype, {
          ...
          render: function(t) {
            ...
            if (!1 !== De.notify(e, "beforeRender")) {
              ...
              } else e.draw(), r(new X({ numSteps: 0, chart: e }));
              return e;
            }
          },
          draw: function(t) {
              ...
              if (en(s))
                for (r = 0, o = s.length; r < o; ++r)
                  (g = s[r]),
                    nn(g) ||
                      en(g) ||
                      ((h = V.measureText(t, d.data, d.gc, h, g)), (f += c));
            } else (h = V.measureText(t, d.data, d.gc, h, s)), (f = c);
        ...
        var gn = $.extend({
          ...
          _autoSkip: function(t) {
            ...
            if (
              ...
              return (
                ...
                fn(t, i, c, V.isNullOrUndef(a) ? t.length : c + a),
                hn(t)
              );
            }
            return fn(t, i), hn(t);
          ...
          _computeGridLineItems: function(t) {
            ...
            for (
              ...
              (i = C[n] || {}),
                (nn(i.label) && n < C.length) ||
                  (n === b.zeroLineIndex && x.offset === w
                    ? ((g = _.zeroLineWidth),
                      (p = _.zeroLineColor),
          ...
          _computeLabelItems: function() {
            ...
            for (
              "top" === p
                ? ((r = h.bottom - _ - x), (o = k ? "left" : "center"))
                : "bottom" === p
                ? ((r = h.top + _ + x), (o = k ? "right" : "center"))
                : "left" === p
                ? ((a = h.right - (m ? 0 : _) - x), (o = m ? "left" : "right"))
                : ((a = h.left + (m ? 0 : _) + x), (o = m ? "right" : "left")),
                t = 0,
                e = b.length;
              t < e;
              ++t
          ...
          _drawGrid: function(t) {
            ...
            if (n.display) {
              var i,
                ...
                u = e.chart,
                d = V._alignPixel,
                c = n.drawBorder ? rn(n.lineWidth, 0, 0) : 0,
                h =
                  e._gridLineItems ||
              ...
              if (c) {
                var f,
                  ...
                  m,
                  v = c,
                  b = rn(n.lineWidth, h.ticksLength - 1, 1),
                  y = h.borderValue;
                e.isHorizontal()
                  ? ((f = d(u, e.left, v) - v / 2),
                    (g = d(u, e.right, b) + b / 2),
          ...
          _drawTitle: function() {
            ...
            if (i.display) {
              ...
              if (t.isHorizontal())
                ...
                var h = "left" === d;
                (a = h ? t.left + u + l.top : t.right - u - l.top),
                  (r = t.top + t.height / 2),
            ...
            buildTicks: function() {
              var t = this,
                ...
                a = (t.ticks = (function(t, e) {
                  ...
                  if (p < 1e-14 && xn(d) && xn(c)) return [f, g];
                  (r = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                    ...
                    (a = Math.ceil(g / p) * p),
                    s &&
                      (!xn(d) && V.almostWhole(d / p, p / 1e3) && (i = d),
                      !xn(c) && V.almostWhole(c / p, p / 1e3) && (a = c)),
                    (r = (a - i) / p),
        ...
        var Tn = pn.extend({
            determineDataLimits: function() {
              ...
              if (s.stacked || h) {
                ...
                for (t = 0; t < u.length; t++)
                  if (
                    ((e = l.getDatasetMeta(t)), l.isDatasetVisible(t) && c(e))
                  )
        ...
        function En(t) {
          ...
          return e.display && t.display
            ? Fn(e.fontSize, z.global.defaultFontSize) + 2 * e.backdropPaddingY
            : 0;
        }
                ...
                ? (function(t) {
                    ...
                    for (e = 0; e < d; e++) {
                      ...
                      var c = t.getIndexAngle(e),
                        h = V.toDegrees(c) % 360,
                        f = Nn(h, i.x, n.w, 0, 180),
                        g = Nn(h, i.y, n.h, 90, 270);
                      f.start < r.l && ((r.l = f.start), (o.l = c)),
                        f.end > r.r && ((r.r = f.end), (o.r = c)),
                        g.start < r.t && ((r.t = g.start), (o.t = c)),
                        g.end > r.b && ((r.b = g.end), (o.b = c));
                    }
            ...
            _drawLabels: function() {
              ...
              if (n.display) {
                var i,
                  ...
                  s = Fn(n.fontColor, z.global.defaultFontColor);
                e.save(),
                  (e.font = o.string),
        ...
        var oi = pn.extend({
            ...
            determineDataLimits: function() {
              ...
              m.length &&
                ...
                (h = ii(s, Qn(d)) || h),
                (f = ii(s, ti(d)) || f),
                (h = h === Gn ? +u.startOf(Date.now(), c) : h),
                (f = f === $n ? +u.endOf(Date.now(), c) + 1 : f),
                (s.min = Math.min(h, f)),
            ...
            buildTicks: function() {
              ...
              return (
                ...
                (i._unit =
                  l.unit ||
                  (s.autoSkip
                    ? ai(l.minUnit, i.min, i.max, c)
                    : (function(t, e, n, i, a) {
                        var r, o;
                        for (r = Zn.length - 1; r >= Zn.indexOf(n); r--)
                          if (
                            ((o = Zn[r]),
                            Xn[o].common && t._adapter.diff(a, i, o) >= e - 1)
                          )
                            return o;
            ...
            _getLabelSize: function(t) {
              var e = this.options.ticks,
                ...
                a = Math.cos(i),
                r = Math.sin(i),
                o = Kn(e.fontSize, z.global.defaultFontSize);
        ...
        function vi(t, e, n, i, a, r) {
          ...
          for (t.beginPath(), o = 0, s = g; o < s; ++o)
            (d = n((u = e[(l = o % g)]._view), l, i)),
              (c = pi(u)),
              (h = pi(d)),
              r && void 0 === f && c && (s = g + (f = o + 1)),
              c && h
                ? ((b = m.push(u)), (y = v.push(d)))
                : b &&
                  y &&
                  (p
                    ? (c && m.push(u), h && v.push(d))
                    : (mi(t, m, v, b, y), (b = y = 0), (m = []), (v = [])));
          mi(t, m, v, b, y), t.closePath(), (t.fillStyle = a), t.fill();
        }
        var bi = {
            id: "filler",
        ...
        var wi = $.extend({
          ...
          draw: function() {
            ...
            if (e.display) {
              var d,
                c = yi(e.rtl, t.left, t.minSize.width),
                h = t.ctx,
              ...
              V.each(t.legendItems, function(e, i) {
                ...
                !(function(t, e, i) {
                  if (!(isNaN(m) || m <= 0)) {
                    ...
                    if (
                      ((h.fillStyle = _i(i.fillStyle, a)),
                      (h.lineCap = _i(i.lineCap, r.borderCapStyle)),
                      (h.lineDashOffset = _i(
                        i.lineDashOffset,
                        r.borderDashOffset
                      )),
                      (h.lineJoin = _i(i.lineJoin, r.borderJoinStyle)),
                      (h.lineWidth = o),
                      (h.strokeStyle = _i(i.strokeStyle, a)),
                      h.setLineDash &&
                        h.setLineDash(_i(i.lineDash, r.borderDash)),
                      n && n.usePointStyle)
                    ) {
          ...
          draw: function() {
            ...
            if (n.display) {
              ...
              (e.fillStyle = V.valueOrDefault(
                ...
                (e.font = o.string),
                t.isHorizontal()
                  ? ((a = c + (f - c) / 2), (r = d + l), (i = f - c))
                  : ((a = "left" === n.position ? c + l : f - l),
                    (r = d + (h - d) / 2),
                    (i = h - d),
        ...
        (function() {
          ...
          function n(n, i, a) {
            ...
            return u || d
              ? Math.min(u ? t(s, n, a) : c, d ? t(l, o, a) : c)
              : "none";
          }
          (V.where = function(t, e) {
            ...
            (V.getRelativePosition = function(t, e) {
              ...
              var l = parseFloat(V.getStyle(r, "padding-left")),
                ...
                c = parseFloat(V.getStyle(r, "padding-bottom")),
                h = o.right - o.left - l - d,
                f = o.bottom - o.top - u - c;
              return {
                x: (n = Math.round(
                  (((n - o.left - l) / h) * r.width) / e.currentDevicePixelRatio
                )),
                y: (i = Math.round(
            ...
            (V.longestText = function(t, e, n, i) {
              ...
              for (o = 0; o < h; o++)
                if (null != (u = n[o]) && !0 !== V.isArray(u))
                  c = V.measureText(t, a, r, c, u);
                else if (V.isArray(u))
                  for (s = 0, l = u.length; s < l; s++)
                    null == (d = u[s]) ||
                      V.isArray(d) ||
                      (c = V.measureText(t, a, r, c, d));
              var f = r.length / 2;
              if (f > n.length) {
        ...
        (Xe._adapters = Qe),
        (Xe.Animation = X),
        (Xe.animationService = Z),
        (Xe.controllers = Zt),
        (Xe.DatasetController = nt),
        (Xe.defaults = z),
        (Xe.Element = $),
        (Xe.elements = _t),
        (Xe.Interaction = ae),
        ...
        (Xe.Ticks = tn),
        (Xe.Tooltip = Ve),
        Xe.helpers.each(li, function(t, e) {
          Xe.scaleService.registerScaleType(e, t, t._defaults);
        }),
        Di))
          Di.hasOwnProperty(Fi) && Xe.plugins.register(Di[Fi]);
        Xe.platform.initialize();
        var Li = Xe;
        return (
          "undefined" != typeof window && (window.Chart = Xe),
          (Xe.Chart = Xe),
          (Xe.Legend = Di.legend._element),
          (Xe.Title = Di.title._element),
          (Xe.pluginService = Xe.plugins),
          (Xe.PluginBase = Xe.Element.extend({})),
          (Xe.canvasHelpers = Xe.helpers.canvas),
          (Xe.layoutService = Xe.layouts),
          (Xe.LinearScaleBase = _n),
          Xe.helpers.each(
            [
              "Bar",
              "Bubble",
    ...
    924: function(t, e, n) {
      ...
      (function(t) {
        ...
        function x(t, e) {
          return !e || ("object" !== d(e) && "function" != typeof e) ? _(t) : e;
        }
        function _(t) {
          if (void 0 === t)
        ...
        var M = void 0 !== t && t.env && "production",
          C = (function(t) {
            v(n, t);
            var e = y(n);
            function n() {
              ...
              return (
                g(this, n),
                w(_((t = e.call(this))), "handleOnClick", function(e) {
                  var n = t.chartInstance,
                    i = t.props,
                    a = i.getDatasetAtEvent,
                    r = i.getElementAtEvent,
                    o = i.getElementsAtEvent,
                    s = i.onElementsClick;
                  a && a(n.getDatasetAtEvent(e), e),
                    r && r(n.getElementAtEvent(e), e),
                    o && o(n.getElementsAtEvent(e), e),
                    s && s(n.getElementsAtEvent(e), e);
                }),
                w(_(t), "ref", function(e) {
                  t.element = e;
                }),
              ...
              m(n, [
                ...
                },
                {
                  ...
                  value: function(t) {
                    var e = "production" !== M && "prod" !== M,
                      i = this.props.datasetKeyProvider !== n.getLabelAsKey,
                      a = t.length > 1;
                    if (e && a && !i) {
                      var r = !1;
                      t.forEach(function(t) {
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    if (this.chartInstance) {
                      ...
                      var o = (0, s.default)(i, this.props.datasetKeyProvider);
                      ...
                      (this.chartInstance.config.data = f(
                        f({}, this.chartInstance.config.data),
                        l
                      )),
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    void 0 === i ||
                      (0, o.default)(n.defaultProps.legend, i) ||
                      (e.legend = i),
                      (this.chartInstance = new r.default(l, {
                        type: a,
                        data: u,
                        options: e,
                        plugins: s
