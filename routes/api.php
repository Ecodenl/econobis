...
Route::namespace('Api')
    ...
    ->group(function () {
        ...
        Route::get('invoice/{administration}/sending/{filter}', 'Invoice\InvoiceController@getInvoicesForSending');
        ...
        Route::post('invoice/{administration}/send-all/{filter}', 'Invoice\InvoiceController@sendAll');
