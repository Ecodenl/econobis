...
Route::namespace('Api')
    ...
    ->group(function () {
        ...
        Route::get('production-project/participant/check-postal-code/{productionProject}/{contact}', 'ParticipationProductionProject\ParticipationProductionProjectController@checkPostalCode');
