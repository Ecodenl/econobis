...
Route::namespace('Api')
    ...
    ->group(function () {
        ...
        Route::get('/housing-file/selection/hr3p-glass-frame-cCurrent-glass-selection/peek', 'HousingFile\HousingFileController@hr3pGlassFrameCurrentGlassSelectionPeek');
