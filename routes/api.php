...
Route::namespace('Api')
    ...
    ->group(function () {
        ...
        Route::post('/contact-energy-supplier', 'AddressEnergySupplier\AddressEnergySupplierController@store');
        Route::post('/contact-energy-supplier/{addressEnergySupplier}', 'AddressEnergySupplier\AddressEnergySupplierController@update');
        Route::post('/contact-energy-supplier/{addressEnergySupplier}/delete', 'AddressEnergySupplier\AddressEnergySupplierController@destroy');
